package org.vanda.studio.modules.runtool;
...
public class RunNowTool implements ToolFactory {
	...
	private class Tool implements Observer<RunEvent>, RunEventListener {
		...
		public Tool(WorkflowEditor wfe, BuildContext bc) {
	...
	public RunNowTool(Repository<String, BuildSystem> buildSystemRepository,
